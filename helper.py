...
def most_successful(df, sport):
    ...
    # Merge the top athletes with the original DataFrame to get additional details
    top_athletes = medal_counts.head(15).merge(df[['Name', 'Sport', 'region']], on='Name', how='left').drop_duplicates('Name')
...
def most_successful_countrywise(df, country):
    ...
    # Count medals per athlete and get the top 10
